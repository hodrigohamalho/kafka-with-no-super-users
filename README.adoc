...
| Kafka | `registry.redhat.io/amq-streams/kafka-39-rhel9:2.9.1` | Red Hat AMQ Streams (Apache Kafka)
...
1. Added *ClusterAction* and internal ACLs for `__*` topics.  
2. The Quarkus application produced messages normally.  
3. Brokers were stopped one by one, and the app continued producing/consuming, showing replication works properly.
